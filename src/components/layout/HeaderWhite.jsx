  ...
  return (
    ...
    >
      <div className="lg:px-[6.25rem] md:px-8 px-5 text-meet_white flex h-full items-center">
        ...
        >
          {/*<button className="lg:w-32 md:w-32 px-5 py-[0.375rem] bg-meet_pink hover:bg-meet_pink_hover rounded-3xl font-bold flex items-center justify-center whitespace-nowrap">*/}
          {/*  {token ? (*/}
